...
/**
 * Returns a UIObject by viewId value provided from [viewId] lambda
 */
fun viewById(viewId: () -> Int): UiObject = device.objectById { viewId() }

/**
 * Returns a UIObject by text value provided from string resources for [stringResId] lambda result.
...
/**
 * Returns a UIObject by text value provided by [text] lambda.
 */
